                ...
                <div class="card-body">
                    ...
                    <div class="row mb-2" id="btnsReport">
                        <div class="table-responsive mt-4">
                            <table class="table text-center table-hover mt-4" id="rol" class="display"
                                style="width:100%">
                                <thead>
                                    <tr>
                                        <th>Nombre</th>
    ...
    function fetchData() {
        fetch("{{route('get_rol')}}", {
            ...
            .then((data) => {
                ...
                $('#rol tbody').on('click', 'button', function() {
                    var action = this.className;
                    var data = table.row($(this).parents('tr')).data();
                    var id_data = data.id;
                    //opciones ver
                    if (action.includes('ver')) {
                        var urlLocal = "http://localhost/sistema/public/admin/rol/show" + '/' +
                            id_data;

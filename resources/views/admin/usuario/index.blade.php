...
<div class="container">
    <div class="row">
        @include ('admin.usuario.modalAgregar')
        @include ('admin.usuario.modalEditar')
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Usuario</div>
                <div class="card-body">
                    <button class="btn btn-outline-success" id="btnAddNew" title="Agregar nuevo Usuario">
                    ...
                    <div class="row mb-2" id="btnsReport">
                        <div class="table-responsive mt-4">
                            <table class="table text-center table-hover mt-4" id="usuario" class="display"
                                style="width:100%">
                                <thead>
                                    <tr>
                                        <th>Usuario</th>
    ...
    function fetchData() {
        fetch("{{route('get_usuario')}}", {
            ...
            .then((data) => {
                ...
                $('#usuario tbody').on('click', 'button', function() {
                    var action = this.className;
                    var data = table.row($(this).parents('tr')).data();
                    var id_data = data.id;
                    //opciones ver
                    if (action.includes('ver')) {
                        var urlLocal = "http://localhost/sistema/public/admin/usuario/show" + '/' +
                            id_data;
